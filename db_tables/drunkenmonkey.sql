...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2019 at 07:59 AM
...
CREATE TABLE `categorylist` (
  ...
  `categoryName` varchar(9) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `productlist` (
  ...
  `variental` varchar(35) CHARACTER SET utf8 DEFAULT NULL,
  `productName` varchar(71) CHARACTER SET utf8 DEFAULT NULL,
  `liquorSize_mL` int(11) DEFAULT NULL,
  `standardDrinks` decimal(3,1) DEFAULT NULL,
  `alcoholVolume_percent` decimal(3,1) DEFAULT NULL,
  `countryOrigin` varchar(11) CHARACTER SET utf8 DEFAULT NULL,
  `age_yo` int(11) DEFAULT NULL,
  `brandName` varchar(16) CHARACTER SET utf8 DEFAULT NULL,
  `closure` varchar(11) CHARACTER SET utf8 DEFAULT NULL,
  `beerStyle` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
  `wineStyle` varchar(3) CHARACTER SET utf8 DEFAULT NULL,
  `wineBody` varchar(13) CHARACTER SET utf8 DEFAULT NULL,
  `pricePerCaseOfSix` decimal(5,2) DEFAULT NULL,
  `pricePerBottle` decimal(4,2) DEFAULT NULL,
  `whiskyStyle` varchar(14) CHARACTER SET utf8 DEFAULT NULL,
  `productDetails` varchar(802) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 'Mid Strength Beer', 'Hahn SuperDry 3.5% Cans 30 Block 375mL', 375, '1.0', '3.5', 'Australia', NULL, 'Hahn', NULL, 'Lager', NULL, NULL, '35.00', '8.00', NULL, 'Hahn Super Dry 3.5 is brewed by combining the best of modern brewing technology with the finest ingredients, resulting in a full flavoured, crisp and refreshing low carb beer. It is brewed with extreme slowness, a similar way to how Hahn create the full-strength SuperDry, to deliver the same SuperDry taste with just 3.5% alcohol'),
(5, 'Low Carb Beer', 'Hahn Ultra Crisp Gluten Free Bottles 330mL', 330, '1.1', '4.2', 'Australia', NULL, 'Hahn', NULL, 'Lager', NULL, NULL, '36.00', '9.00', NULL, 'Hahn Ultra Crisp is an easy-drinking, lower carb lager brewed with a revolutionary new process using rice instead of the standard wheat or barley to create a cleaner, crisper beer that won’t weigh you down. The beer is brewed with a specially selected yeast and fermented at cool temperatures to produce a unique crispness, whilst notes of Saaz hops makes for a light and refreshing aroma and taste.'),
(6, 'Cabernet Sauvignon', 'Penfolds Bin 407 Cabernet Sauvignon 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '333.00', '33.00', NULL, 'Launched with the 1990 vintage in 1993, Bin 407 was developed in response to the increasing availability of high quality cabernet sauvignon'),
(7, 'Shiraz', 'Penfolds Grange 2015', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Cork', NULL, 'Dry', 'Full Bodied', '256.00', '40.00', NULL, 'With an unbroken line of vintages from the experimental 1951, Grange clearly demonstrates the synergy between shiraz and the soils and climates of South Australia. On the nose, an eruption of fruits. Dark coffee grind, malt and tapenade merge with black earths, almost verging on peat. On the palate, initially the \'enlivened\' dark fruits of a Christmas pudding or boiled fruitcake mix demand attention. But there\'s much more to complement these fruits - impressions of ironstone, graphite, iodine, black ink and a black pudding viscosity. Formidable meshed tannins, the oak has entwined itself invisible. Certainly a wine of its vintage. A Grange of 2015. Peak drinking 2022 - 2050.'),
(8, 'Cabernet Shiraz', 'Penfolds Bin 389 Cabernet Shiraz 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '234.00', '45.00', NULL, 'Bin 389 was often referred to as ‘Baby Grange’, in part because components of the wine are matured in the same barrels that held the previous vintage of Grange. On the nose, Much more than a first-wave impression of blackcurrant/cassis cabernet-driven aromatics...A second of chive, mustard spice, beeswax, lemon/honey tea and thyme flowers. A third of cherry-wood, sarsaparilla, aniseed. A fourth of wet cold steel and a wet peppercorn tree. The palate is full and rich, flavours of a platter of charcuterie meats and pastrami dominate. Also vying for taste and textural attention are pomegranate, cranberry, Madagascan vanilla pod, liquorice straps. The youthful profile is tempered by softened and even tannis. Peak drinking Now - 2030.'),
(9, 'Shiraz', 'Penfolds St Henri Shiraz 2016', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '330.00', '60.00', NULL, 'St Henri is a time-honoured and alternative expression of shiraz, and an intriguing counterpoint to Grange. It is unusual among high quality Australian red wines as it does not rely on any new oak. A wine that immediately invokes interest, black cherry, mulberry, blackcurrant, boysenberry and more are propelled from the glass. A subliminal waft of stare anise and savoury spices (not sweet) hover above. On the palate, red and dark-fruited, a compote of fresh prune and quince. 2016 + tempered shiraz + House Style + Penfolds = an assured St Henri collectable. Peak drinking 2022 - 2055.'),
(10, 'Shiraz', 'Penfolds Kalimna Bin 28 Shiraz 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '446.00', '66.00', NULL, 'Kalimna Bin 28 offers a showcase of warm climate Australian shiraz – ripe, robust and generously flavoured. Exuberant aromatics. At first, back to school – memories of black jelly beans, then a gentle spectral gradation to red liquorice and redcurrants. Adhering to this colour theme, goji berry, wild raspberry and a red-fruited chutney. A transient suggestion of sandalwood spices? Maybe. The palate is well balanced. Whirling black fruits and an oscillating shiraz disposition - Bin 28 by any other name, personality intact. Flavours akin to a consommé of dried porcini mushrooms; structurally embedded with grainy/sandy tannins. Additionally, tobacco, tobasco and tamarind noted. Peak drinking Now - 2030.'),
(11, 'Shiraz', 'Penfolds RWT Barossa Valley Shiraz 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '332.00', '78.00', NULL, 'RWT Barossa Valley Shiraz presents an admirable alternative to the multi-regional sourcing and American oak maturation that are hallmarks of Grange, expressing instead, single region Barossa Valley shiraz matured only in French oak. Vibrant nose, initially a life of trademark tar/bitumen and subtle V.A above scents of assorted capaccio meats, steak tartare, green olive, capers and rosemary, moving to patisserie scents of almost croissant and cinnamon bun, perhaps creme burlee glaze upon sitting/swirling. On the palate, medium bodies with a firm and binding structure. Mouth watering acidity assisted by chalky tannins and absorbed integrated oak. Currently youthful and energetic, yet this vintage already impatiently awaits its secondary and tertiary maturation phases. Peak drinking Now - 2037.'),
(12, 'Pinot Noir', 'Penfolds Bin 23 Pinot Noir 2018', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Light Bodied', '588.00', '87.00', NULL, 'Bin 23’s name is derived from the place the wine matures, ‘Cellar 23’ at Magill Estate and follows in the footsteps of the success and development of the Penfolds Cellar Reserve Adelaide Hills Pinot Noir. On the nose, an immediate ascent of delicate white strawberry and white raspberry pastille fruits quickly followed by a garnish of fresh thyme flowers and Hungarian sweet paprika. On the palate medium bodied, with cherry and strawberry fruits inducing a refreshing mouth-watering/slaivating grip. Underneath, impressions of tilled wet-earth and aligned parsnip/turnip flavours. Oak imparts a structural rather than a flavour imprint. Peak drinking Now - 2024.'),
(13, 'Shiraz', 'Penfolds Bin 128 Coonawarra Shiraz 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '499.00', '50.00', NULL, 'With each vintage release the cool climate Bin 128 Coonawarra Shiraz provides an interesting counterpoint to the more opulent and richly concentrated warm climate Kalimna Bin 28 Shiraz. On the nose, an aromatic veil of black-truffled earthiness meshed with porcini mushroom over a dark chocolate base. Beneath, spiced French oak evident. On the palate, a quilt of berried shiraz fruits and lingering tanins provide a structured palate platform. A Coonawarra line of acidity affords both vivacity and length of palate. French oak there to help! Peak drinking 2020 - 2032.'),
(14, 'Shiraz', 'Penfolds Bin 150 Marananga Shiraz 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Cork', NULL, 'Dry', 'Full Bodied', '477.00', '55.00', NULL, 'Bin 150 Marananga Shiraz is a sub-regional expression that is unmistakably Penfolds in character. On the nose, an aromatic jigsaw. The expected: formic, bayleaf, fig, quince black pudding. The unexpected: cookies and cream, golden gaytime icecream. The incredulous: Iced coffee, sticky date pudding, shortbread. On the palate, Certainly less confected (literally) and meatier than the nose might suggest – flavours akin to Greek lamb and rosemary, bone marrow/steak tartare, carpaccio of assorted meats. Yet fruits and berries are evident, manifested primarily via an impression of a juniper/strawberry/cranberry reduction. And cola. Sleek tannins and the interface of judicious oak facilitate a plush and glossy Bin 150 disposition, avec sheen. Peak drinking 2020 - 2032.'),
(15, 'Shiraz Blend', 'Penfolds Bin 138 Shiraz Grenache Mataro 2017', 750, '8.3', '14.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Full Bodied', '466.00', '59.00', NULL, 'Bin 138 draws its inspiration from the wines of Southern Rhône, where shiraz, grenache and mataro (mourvèdre) are blended in varying proportions to create full-bodied wines possessing rich and heady perfume. The nose is comfortably embedded in the savoury spectrum, scent detected of charcuterie cold meats, a balsamic reduction, fresh fruits elude with air. On the palate, earthy Barossa elements abound, coupled with savoury red meats. An agglomerate of assorted tannin shapes derived from the trio of shiraz, grenache and mataro set the textural stage – in parallel with a juicy/fruity succulence. All three varieties carry their weight, all three generously add to the mix. Peak drinking Now - 2028.'),
(16, 'Chardonnay', 'Penfolds Bin 311 Chardonnay 2018', 750, '7.7', '13.0', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Medium Bodied', '399.00', '39.00', NULL, 'Bin 311 Chardonnay truly reflects the winemakers’ mantra ‘we always go where the fruit grows best and where it best suits style’. On the nose, full-flavoured, endowed with a concentrated fruit spectrum of citrus, grapefruit and white peach. Hints of sherbet, camomile and goats cheese complex the aromatic offer – a chardonnay cast assembled from three States of Australia. On the palate, first and foremost, this wine extolls freshness, yet not at the expense of an endearing richness and generosity of flavour. Rockmelon and white peach fruits are pronounced. Underlying sherbet and fresh lemon tart impressions coupled with a lovely creaminess add to the structural and flavour pool. Peak drinking Now - 2025.'),
(17, 'Riesling', 'Penfolds Bin 51 Eden Valley Riesling 2019', 750, '7.7', '12.5', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Light Bodied', '421.00', '49.00', NULL, 'Created in the 1990s as part of the evolving Penfolds white wine development program, Bin 51 captures many of the attributes of the Eden Valley locale. When opened and swirled mandarin, lemon cordial and orange blossom aromatics are immediately unleashed on the nose. Upon closer inspection, hints of lavender talc, lychee and the faintest waft of cardamom spice. On the palate, tempting flavours of lemon tea cake, apple strudel with jasmine florals and Tahitian lime leaf round out a palate nevertheless still enlivened by chalky acidity. ‘Softened’ and very approachable now. Recommend more immediate drinking, with medium-term Eden Valley Riesling cellarability. Peak drinking Now - 2026.'),
(18, 'Chardonnay', 'Penfolds Reserve Bin A Chardonnay 2018', 750, '7.7', '13.0', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Medium Bodied', '211.00', '29.00', NULL, 'Reserve Bin A Chardonnay has evolved into a wine that is now a distinctive, single-region style in its own right, with a contemporary and expressive Adelaide Hills chardonnay persona. Not the archetypical stone-fruited Bin A this vintage – to the fore on the nose: lemon curd, mandarin and nashi pear with a skerrick of shortbread and creamy custard/vanilla slice sans icing. Initially, an intriguing subtle gentleness on the palate. A glycerolic viscosity interlocks with the natural acidity inducing a mouth-watering juiciness and just a rasp of flint at the very end, adding length and zest. Peak drinking 2021 - 2035.'),
(19, 'Shiraz', 'Penfolds Magill Estate Shiraz 2017', 750, '8.3', '14.0', 'Australia', NULL, 'Penfolds', 'Cork', NULL, 'Dry', 'Full Bodied', '233.00', '33.00', NULL, 'The single-vineyard Magill Estate Shiraz is intrinsically linked to Penfolds beginnings. On the nose, florals instantly arise. Violet sits aside a diverse cottage garden mix, a floral bouquet pleasantly spiced with mineral elements. A coulis of mulberry and blueberry - Very Magill! On the palate this wine is balanced, fresh and alluring. Succulent, mouth-watering acidity coupled with fine, feathery tannins – all in tandem with the wine’s medium-bodied engagement. Cherry and pistachio (nougat) and cranberry (muesli bar) flavours spark interest. This, coupled with cola/chinotto and a beguiling ‘flintiness’, opens a flavour and textural window for any lover of Italian red wine channelling Magill Estate! Peak drinking Now - 2034.'),
(20, 'Chardonnay', 'Penfolds Yattarna Chardonnay 2017', 750, '7.7', '13.0', 'Australia', NULL, 'Penfolds', 'Screw Cap', NULL, 'Dry', 'Medium Bodied', '230.00', '55.00', NULL, 'Launched in 1998 with the 1995 vintage, Yattarna is the result of one of the most comprehensive, focused and highly publicised wine development projects ever conducted in Australia. On the nose, a citrus edge leans towards lime/lime leaf in tandem with Granny Smith apple and honeydew granita. Background complexing aromas of creamy Greek yoghurt/tzatziki and lanolin, no doubt arising from courting yeast lees for eight months in French barriques. On the palate, this wine is elegant, yet profoundly powerful at the same time. Lime and a hint of jackfruit sits well with the creamy texture. Peak drinking 2022 - 2037.'),
(21, 'Craft Beer', 'Furphy Refreshing Ale Cans 375mL', 375, '1.3', '4.4', 'Australia', NULL, 'Furphy', 'Can Closure', 'Ale', NULL, NULL, '40.00', '9.00', NULL, 'Furphy Refreshing Ale has been embraced by Victorians as a local beer made for local people. Made with 100% Victorian Hops & Malt, Furphy Refreshing Ale is an easy drinking beer with a touch of craft in its DNA.'),
(22, 'Craft Beer', 'Furphy Refreshing Ale Bottles 750ml', 750, '2.6', '4.4', 'Australia', NULL, 'Furphy', 'Crown Seal', 'Ale', NULL, NULL, '36.00', '7.00', NULL, 'Furphy Refreshing Ale has been embraced by Victorians as a local beer made for local people. Made with 100% Victorian Hops & Malt, Furphy Refreshing Ale is an easy drinking beer with a touch of craft in its DNA.'),
(23, 'Australian Beer', 'Furphy Refreshing Ale Can 30 Block 375mL', 375, '1.3', '4.4', 'Australia', NULL, 'Furphy', 'Can Closure', 'Ale', NULL, NULL, '34.00', '6.00', NULL, 'Furphy Refreshing Ale has been embraced by Victorians as a local beer made for local people. Made with 100% Victorian Hops & Malt, Furphy Refreshing Ale is an easy drinking beer with a touch of craft in its DNA. For a limited time only in 30pks.'),
(24, 'International Beer', 'Guinness Extra Stout 750mL', 750, '3.6', '6.0', 'Ireland', NULL, 'Guinness', NULL, 'Stout', NULL, NULL, '35.00', '6.00', NULL, 'The classic Irish dark Stout that started it all, crafted to perfection for over 200 years. Crack it open, and the first sip tastes as fresh as ever. The unmistakeable deep-dark colour. The crisp hint of roasted barley, the fresh breeze of hops'),
(25, 'Stout', 'Guinness Extra Stout Bottles 375mL', 375, '1.8', '6.0', 'Ireland', NULL, 'Guinness', NULL, 'Stout', NULL, NULL, '36.00', '12.00', NULL, 'This is it, the Stout that started it all, crafted to perfection for over 200 years. Crack it open, and the first sip tastes as fresh as ever. The unmistakeable deep-dark colour. The crisp hint of roasted barley, the fresh breeze of hops. The refreshing bite. The bittersweet reward. Pure beauty; pure Guinness.'),
(26, 'Stout', 'Guinness Foreign Extra Stout 7.5%', 330, '2.0', '7.5', 'Ireland', NULL, 'Guinness', 'Can', 'Stout', NULL, NULL, '33.00', '13.00', NULL, 'Fruit and caramel flavours begin, smoky notes and a vibrant bitterness follow. Where extra hops and a stronger alcohol percentage were once used to preserve the beer, allowing it to survive and thrive during long sea voyages, now they yield its bold taste and unique flavour profile.'),
(27, 'Scotch Whisky', 'Lagavulin 16 Year Old Scotch Whisky 700mL', 700, '24.0', '43.0', 'Scotland', 16, 'Lagavulin', 'Cork', NULL, NULL, NULL, '32.00', '11.00', NULL, 'This peaty Single Malt dates back to 1816, when John Johnston and Archibald Campbell each constructed a distillery on what today is the Lagavulin site. After Johnston died, Campbell consolidated the two, before selling it to malt merchant Alexander Graham. Today it continues to uphold the traditions of its past, using meticulous preparation to create powerful whisky. Their signature 16 year old malt has a strong peat, smoke and seaweed nose that is followed by a nutty complexity and light fruitiness. In the mouth characters of Charcoal, dry woodiness and iodine followed by chilli chocolate and a hint of toffee.'),
(28, 'Scotch Whisky', 'Dimple 15 Year Old Scotch Whisky 700mL', 700, '22.0', '40.0', 'Scotland', 15, 'Dimple', 'Screw Cap', NULL, NULL, NULL, '415.80', '69.99', 'Blended Whisky', 'Flavoursome, light and smooth, Dimple 15 year old Scotch Whisky is an elegant Scotch. For the distinguished Scotch drinker, it is delicate on the palate with a hint of dark chocolate. Best served on the rocks or with a dash of water.'),
(29, 'Scotch Whisky', 'Dimple 12 Year Old Scotch Whisky 700mL', 700, '22.0', '40.0', 'Scotland', 12, 'Dimple', 'Screw Cap', NULL, NULL, NULL, '254.70', '45.95', 'Blended Whisky', 'Dimple is famous for not only its unique bottle shape, but by its long standing reputation for producing one of the finest blended malts available. Using malts predominantly from Glenkinchie and Linkwood, Dimple 12 Year Old is a beautifully well-rounded Scotch with surprising depth.'),
(30, 'Scotch Whisky', 'Glenfiddich 12 Year Old Single Malt Scotch Whisky 700mL', 700, '22.0', '40.0', 'Scotland', 12, 'Glenfiddich', 'Cork', NULL, NULL, NULL, '354.00', '59.00', 'Single Malt', 'After 12 years, this signature single malt by Glenfiddich - the pioneer of the prestigious single malt category - offers a distinctive fresh and fruity nose with a hint of pear followed by a palate of butterscotch, cream, malt and a subtle oak thanks to its long maturation in Oloroso sherry and bourbon oak casks.'),
(31, 'American Whiskey', 'Blanton\'s Single Barrel Gold Edition Kentucky Straight Bourbon 700mL', 700, '22.0', '40.0', 'USA', NULL, 'Blanton', 'Cork', NULL, NULL, NULL, '362.40', '60.99', NULL, 'Blanton\'s trademark bottle shape and iconic horse and jockey are a symbol of years of exceptional quality. Their Gold Edition was created for the discerning connoisseur who appreciates exceptional smoothness and clean finish in their bourbon whiskey. The rich taste of dark chocolate fudge, citrus rind, oak and subtle cream notes are combined with the spiciness of pepper and rye leading to an incredibly long finish that challenges the world’s finest single malts and rarest cognacs in complexity and character. Best served neat or with a splash of water.'),
(32, 'American Whiskey', 'Blanton\'s Single Barrel Special Reserve Kentucky Straight Bourbon 700mL', 700, '22.0', '40.0', 'USA', NULL, 'Blanton', 'Cork', NULL, NULL, NULL, '362.40', '60.99', NULL, 'Blanton\'s Special Reserve is ideal for those new to Single Barrel Bourbons. A sweeter taste profile with aromas of dry citrus, raisin and light vanilla, finishing with crisp spicy notes and a hint of cinnamon apple.'),
(33, 'Sauvignon Blanc', 'Stoneleigh Wild Valley Sauvignon Blanc', 750, '8.0', '13.5', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', NULL, '102.54', '17.99', NULL, 'The ultimate expression of minimal intervention winemaking philosophy, this wine is wild fermented by the micro-flora that occur naturally in the Rapaura environment. This gives the wine a richer, more textural palate with a generous mouthfeel that balances out the acidity. Exhibiting the distinctive citrus and passionfruit aromas and flavours expected from Stoneleigh, this wine also has hints of nectarine, making it the perfect accompaniment to a range of dishes.'),
(34, 'Pinot Noir', 'Stoneleigh Wild Valley Pinot Noir', 750, '8.0', '13.5', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', 'Light Bodied', '102.54', '17.99', NULL, 'The ultimate expression of minimal intervention winemaking philosophy, this wine is wild fermented by the micro-flora that occur naturally in the Rapaura environment. This gives the wine a richer, more textural palate bursting with red fruit strawberries, raspberries, boysenberries and dark cherry notes - complemented by subtle savoury and toasty notes.'),
(35, 'Pinot Gris', 'Stoneleigh Rapaura Pinot Gris', 750, '7.7', '13.0', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', NULL, '136.80', '23.99', NULL, 'The Rapaura Pinot Gris by Stoneleigh is all about concentration and textural weight. It has warm, complex fruit aromas of poached pear and yellow peach. The palate is full bodied, with rich, lingering flavours, a lovely slippery mouth feel and great weight.'),
(36, 'Pinot Gris', 'Stoneleigh Pinot Gris', 750, '8.3', '14.0', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', NULL, '60.00', '10.00', NULL, 'A straw colour compliments the intense pear aromas with peach and melon notes. A textured palate with sweet rounded ripe stone fruit flavours and a touch of spice.'),
(37, 'Pinot Noir', 'Stoneleigh Rapaura Pinot Noir', 750, '7.7', '13.0', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', 'Light Bodied', '100.68', '16.78', NULL, 'Rapaura Series takes the best elements of Stoneleigh wines and add a number of extra dimensions resulting in refined, premium quality wines with more complexity that deliver the purest and most intense expression of Marlborough. It is a bouquet of berries black cherry sweet leather and savoury toasty spice. Ripe dark red berry fruit flavours dominate yet the palate is soft and supple.'),
(38, 'Chardonnay', 'Stoneleigh Chardonnay', 750, '8.0', '13.5', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', NULL, NULL, '14.95', NULL, 'Stoneleigh Chardonnay is perhaps one of the best examples yet of rich, toasty, creamy Chardonnay that avoids looking old fashioned and shows up some contemorary Chardonnays as being thin. Lovely restrained power and acidity. Simply delicious.'),
(39, 'Pinot Noir', 'Stoneleigh Pinot Noir', 750, '8.0', '13.5', 'New Zealand', NULL, 'Stoneleigh', 'Screw Cap', NULL, 'Dry', 'Light Bodied', '60.00', '10.00', NULL, 'Stoneleigh Pinot Noir is unique in style, showing both individual vineyard and regional terroir. The winemaker has reflected this in the winemaking process, capturing the bright, rich, red berry fruit characters and a delicate palate structure showing both elegance and finesse.'),
(40, 'Pinot Noir Chardonnay Pinot Meunier', 'Moët & Chandon Brut Impérial Champagne NV', 750, '7.1', '13.0', 'France', NULL, 'Moet and Chandon', 'Cork', NULL, 'Dry', NULL, '353.40', '61.99', NULL, 'Moët & Chandon Brut Impérial, with its perfect balance of Pinot Noir, Chardonnay and Pinot Meunier has become one of the world\'s most-loved Champagnes. \'Moët\' is characterised by bright fruitiness and elegant maturity. The palate reveals subtle pear, citrus and brioche notes.'),
(41, 'Chardonnay Pinot Noir', 'Jacob\'s Creek Chardonnay Pinot Noir', 750, '6.8', '11.0', 'Australia', NULL, 'Jacob\'s Creek', 'Cork', NULL, 'Dry', NULL, '40.00', '6.95', NULL, 'Jacob\'s Creek Chardonnay Pinot Noir consistently out shines the more expensive opposition for freshness and vibrancy. The citrus and toasted cashew flavours of Chardonnay are married beautifully to the fresh bread crust characters of Pinot Noir.'),
(42, 'Pinot Noir Chardonnay Pinot Meunier', 'Mumm Cordon Rouge Brut NV', 750, '7.1', '14.0', 'France', NULL, 'Mumm', 'Cork', NULL, 'Dry', NULL, '263.70', '43.95', NULL, 'Mumm has a long and proud history of producing the one of the world\'s most consistent Non-Vintage Champagnes on the market with elegance, length of flavour and a pristine finish. Mumm\'s quality year in, year out is assisted along by the quite staggering amount of reserve stock available in their cellars consisting of all their prestige wines. Not only is this the perfect celebratory Champagne it is also a wonderful food pairing wine due to the high proportion of Pinot Noir lending a definite complexity that has become a trademark. An explosion of freshness in the mouth, followed by strong persistence. The complex aromas of fresh fruit and caramel perpetuate the intensity.');
...
--
-- Table structure for table `product_categorylist`
--

CREATE TABLE `product_categorylist` (
  `productId` int(11) DEFAULT NULL,
  `categoryId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `product_categorylist`
--

INSERT INTO `product_categorylist` (`productId`, `categoryId`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 1),
...
--
-- Table structure for table `product_imagelist`
--

CREATE TABLE `product_imagelist` (
  `productId` int(11) DEFAULT NULL,
  `imageId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `product_imagelist`
--

INSERT INTO `product_imagelist` (`productId`, `imageId`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
